                    ...
                    <div className="flex flex-col justify-center lg:max-w-[560px]">
                        ...
                        >
                            <div className="space-y-4 sm:space-y-5">
                                ...
                                >
                                    <span className="block">Le site web premium</span>
                                    <span className="block text-[var(--accent)]">pour votre Garage.</span>
                                </motion.h1>
                                ...
                                >
                                    Acquisition locale, conception sur-mesure et prise de contact immédiate. Démarquez-vous de la concurrence, sécurisez votre image et augmentez vos passages en atelier.
                                </motion.p>
                            </div>
